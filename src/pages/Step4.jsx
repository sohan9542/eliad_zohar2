...
const Step4 = ({ setPage, setPpc_budget }) => {
  return (
    <div className=" min-h-screen relative w-full bg_home ">
          ...
          <div className="pr-0 px-2 lg:pr-16">
            ...
            <div className=" w-full grid px-4 lg:px-0 grid-cols-1 mt-12 lg:grid-cols-2 gap-x-7 gap-y-9 pl-4 lg:pl-16">
              <div
                ...
                className=" px-12 hover:bg-pr hover:text-white text-2xl mt-1 py-5 flex items-center   font-bold border-2 border-white   text-white  rounded-3xl"
              >
                ₪25,000 - ₪50,000
              </div>
              <div
      ...
      <div className=" w-full relative z-20 grid pt-28 pb-8  lg:pt-44 grid-cols-1 lg:grid-cols-3">
        <div className=" hidden lg:block"> </div>
