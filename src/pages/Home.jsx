    ...
    <div className=" min-h-screen w-full relative bg_home">
      ...
      <div className=" w-full relative z-20 flex items-center justify-between pt-5 pl-28 lg:pl-60 pr-0 lg:pr-16">
        ...
        <div className=" hidden lg:block">
          <button
            onClick={() => setPage(2)}
            className=" px-4 mt-1 py-2 flex items-center gap-1 text-xl border font-bold hover:bg-pr hover:border-transparent hover:text-black border-white rounded-3xl text-white"
          >
      ...
      <div className=" w-full relative z-20 mt-16 lg:mt-0 py-12 grid grid-cols-1 lg:grid-cols-3">
        ...
        <div className=" lg:pr-16 pr-8 lg:col-span-2">
          <h1
            style={{ direction: "rtl" }}
            className=" text-5xl lg:text-9xl font-bold w-full text-right text-white"
          >
            נקים עבורך <br /> את הקולקציה <br /> הבאה.
          </h1>
          <p
            style={{ direction: "rtl" }}
            className=" text-lg lg:text-2xl font-light text-gray-200 text-right w-full py-8 pl-4 lg:pl-80"
          >
          ...
          <div className=" w-full flex items-center justify-end mt-5">
            <button
              ...
              onClick={() => setPage(2)}
              className=" px-12 hidden lg:flex hover:bg-white font-bold text-4xl mt-1 py-5  items-center  border  bg-pr border-transparent text-black "
            >
            ...
            <button
              style={{ borderRadius: "50px" }}
              onClick={() => setPage(2)}
              className=" px-4 flex lg:hidden hover:bg-white font-bold text-3xl mt-1 py-3  items-center  border  bg-pr border-transparent text-black "
            >
              <div className="flex items-center font-bold text-black pt-1">
                <MdOutlineKeyboardArrowLeft className="mGap" />
                <MdOutlineKeyboardArrowLeft className="mGap" />
      ...
      <div className=" w-full relative hidden lg:block z-20 pt-20 pl-0 lg:pl-10">
        <div className="flex items-center">
          <a href="#" className=" h-52 w-24 relative parent">
            <img
              src={avatar1}
              style={{ width: "100%", height: "100%", objectFit: "cover" }}
              className=" node "
              alt=""
            />
            <div className=" h-20 hver absolute top-16 left-2 z-20 flex rounded-full w-20 bg-pr  items-center justify-center text-black">
          ...
          <p className="text-2xl flex items-center gap-4 text-white pl-0 lg:pl-3">
            <CgArrowLongLeft className=" w-12 h-12" />
            בין הפרויקטים שלנו
          </p>
        </div>
      </div>
      <div className=" w-full relative block  lg:hidden z-20 pl-3 lg:pl-10">
        <div className="flex items-center gap-1">
          <a href="#" className=" h-32 w-14 relative parent">
            <img
              src={avatar1}
              style={{ width: "100%", height: "100%", objectFit: "cover" }}
              alt=""
            />
             <div className=" h-12 w-12 hver absolute top-10 left-1 z-20 flex rounded-full  bg-pr  items-center justify-center text-black">
              <BsGlobe className="w-8 h-8" />
            </div>
          </a>
          <a href="#" className=" h-32 w-14 relative parent">
          ...
          <p className="text-lg flex items-center gap-1 text-white pl-0">
            <CgArrowLongLeft className=" w-8 h-8" />
            בין הפרויקטים שלנו
          </p>
        </div>
      </div>
