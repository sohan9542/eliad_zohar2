  ...
  return (
    <div className=" min-h-screen relative w-full bg_home ">
      ...
      <div className=" line_verticla relative">
          ...
          <div  onClick={() => setPage(4)} style={{left:"55px"}} className=" bg-pr  w-10 h-10 rounded-full flex items-center justify-center text-black text-xl font-bold absolute -top-4 ">
            2
          </div>
      ...
      <div className=" w-full relative z-20 py-32 lg:pl-60 gap-20 grid grid-cols-1 lg:grid-cols-3 pt-32 lg:pt-40">
        ...
        <div className=" pr-0 lg:pr-16 col-span-2 flex items-center gap-20">
          <div className="pr-0 px-2 lg:pr-16">
            ...
            <div className=" w-full grid px-4 lg:px-0 grid-cols-1 mt-12 lg:grid-cols-2 gap-x-7 gap-y-4 lg:gap-y-9 pl-4 lg:pl-0">
              <div
                onClick={() => {
                ...
                className=" px-8 hover:bg-pr cursor-pointer hover:text-white text-2xl mt-1 py-3 justify-center lg:py-6 flex items-center  font-light  lg:font-semibold border-2 border-white   text-white  rounded-3xl"
              >
                ₪25,000 - ₪50,000
              </div>
              <div
      ...
      <div className=" w-full relative z-20 grid pt-0 pb-8  lg:pt-60 grid-cols-1 lg:grid-cols-3">
        <div className=" hidden lg:block"> </div>
